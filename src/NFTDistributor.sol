...
contract NFTDistributor is Initializable, AccessControlUpgradeable {
    ...
    function updateUserFee(address user, uint8 fee, uint256 era) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function updateUser(string memory utility, address _user, uint256 era, uint256 value) external onlyRole(DEFAULT_ADMIN_ROLE) {
